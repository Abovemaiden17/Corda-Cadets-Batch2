...
@InitiatingFlow
@StartableByRPC
class UserFlowsValidate(
                        private val user: Party,
    ...
    override fun call():SignedTransaction {
        ...
        val outputState = UserState(inputStateData.email,inputStateData.username,inputStateData.password,ourIdentity,user,true,inputStateData.linearId)//, listOf(ourIdentity)
        println(outputState)
        val txCommand =
                Command(UserContract.Commands.Validate(),listOf(ourIdentity.owningKey,user.owningKey ))
        ...
        val sessions = initiateFlow(user)
